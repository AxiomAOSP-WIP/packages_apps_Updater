...
public final class Constants {
    ...
    public static final String PROJECT_NAME_PREFIX = "axiom-";
    public static final String SF_PROJECT_NAME = "axiom-os";
    // version will be set according to the update version in the mirrors function
    public static final String SF_PROJECT_ROOT_PATH_NAME = "axiom-";
    public static final String[] axiomMirrors = { "Europe", "Usa", "Asia SE" };
    ...
    public static final String PROP_DEVICE = "ro.axiom.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.axiom.releasetype";
    public static final String PROP_ZIP_TYPE = "ro.axiom.ziptype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "lineage.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "axiom.updater.uri";
